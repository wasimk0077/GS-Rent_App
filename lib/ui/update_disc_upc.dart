...
class UpdateDiscoverUpcoming extends StatefulWidget {
  // const UpdateDetailsViews({Key? key}) : super(key: key);
  final String docID;//if you have multiple values add here
  UpdateDiscoverUpcoming(this.docID, {Key? key}): super(key: key);

  @override
  State<UpdateDiscoverUpcoming> createState() => _UpdateDiscoverUpcomingState();
}

class _UpdateDiscoverUpcomingState extends State<UpdateDiscoverUpcoming> {
                    ...
                    child: MaterialButton(
                      ...
                      if(Residentialcheck==false)
                      {
                        DocUser.set
                          ...
                          context,
                          MaterialPageRoute(
                            builder: (context) => AddImages(widget.docID.toString())
                          ),
                        ))))
