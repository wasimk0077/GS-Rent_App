...
class BarChartSample2 extends StatefulWidget {
  ...
  BarChartSample2(this.RES,this.MNC,this.WARE,this.BANK,this.COMM, {Key? key}) : super(key: key);
...
class BarChartSample2State extends State<BarChartSample2> {
  ...
  Widget getTitles(double value, TitleMeta meta) {
    ...
    switch (value.toInt()) {
      case 0:
        text = const Text('MNC', style: style);
        break;
      case 1:
        text = const Text('RES', style: style);
        break;
      case 2:
        text = const Text('WARE', style: style);
        break;
      case 3:
        text = const Text('BANK', style: style);
        break;
      case 4:
        text = const Text('COMM', style: style);
        break;
      case 5:
