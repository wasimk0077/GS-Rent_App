...
class PropertyTypeComm extends StatefulWidget {
  const PropertyTypeComm({Key? key}) : super(key: key);

  @override
  State<PropertyTypeComm> createState() => _PropertyTypeCommState();
}

class _PropertyTypeCommState extends State<PropertyTypeComm> {
  int CommPropsTotal = 0;
  int CommPropsVacant = 0;
  int CommTotalRent = 0;
  int CommTotalAsset = 0;
  int CommPropsOcc = 0;
  int CommPropsUpcom = 0;
  int yield = 0;
  ...
  getData() async {
    await FirebaseFirestore.instance
      ...
      for (var i in value.docs) {
        ...
        if ((i["Property_Details"]["Property_Types"]["Commercial"]) == true) {
          ...
          CommPropsTotal = CommPropsTotal + 1;
          print(CommPropsTotal);
        }
    ...
    await FirebaseFirestore.instance
      ...
      for (var i in value.docs) {
        ...
        if (((i["Property_Details"]["Property_Types"]["Commercial"]) == true) &&
          ...
          CommPropsVacant = CommPropsVacant + 1;
          print(CommPropsVacant);
        }
    ...
    await FirebaseFirestore.instance
        ...
        .then((value) {
      for (var i in value.docs) {
        if ((i["Property_Details"]["Property_Types"]["Comm"]) == true) {
          if ((i["Property_Details"]["Asset"]) != "") {
            CommTotalAsset =
                CommTotalAsset + int.parse((i["Property_Details"]["Asset"]));
          }
      ...
      for (var i in value.docs) {
        if ((i["Property_Details"]["Property_Types"]["Commercial"]) == true) {
          if ((i["Property_Details"]["Rent"]) != "") {
            CommTotalRent =
                CommTotalRent + int.parse((i["Property_Details"]["Rent"]));
          }
        }
      }
      // suggestionslist=Properties;
    ...
    await FirebaseFirestore.instance
      ...
      for (var i in value.docs) {
        ...
        if (((i["Property_Details"]["Property_Types"]["Commercial"]) == true) &&
          ...
          CommPropsUpcom = CommPropsUpcom + 1;
          print(CommPropsVacant);
        }
      ...
      if (CommTotalAsset != 0) {
        yield = (((CommTotalRent) * 100) / (CommTotalAsset)).toInt();
      }
      // suggestionslist=Properties;
    });
  }
