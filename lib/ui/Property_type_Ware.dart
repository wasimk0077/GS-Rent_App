...
class _PropertyTypeWareState extends State<PropertyTypeWare> {
  int WarePropsTotal = 0;
  int WarePropsVacant = 0;
  int WareTotalRent = 0;
  int WareTotalAsset = 0;
  int WarePropsOcc = 0;
  int WarePropsUpcom = 0;
  int yield = 0;
    ...
    await FirebaseFirestore.instance
      ...
      for (var i in value.docs) {
        ...
        if ((i["Property_Details"]["Property_Types"]["Warehouse"]) == true) {
          ...
          WarePropsTotal = WarePropsTotal + 1;
          print(WarePropsTotal);
        }
    ...
    await FirebaseFirestore.instance
      ...
      for (var i in value.docs) {
        ...
        if (((i["Property_Details"]["Property_Types"]["Warehouse"]) == true) &&
          ...
          WarePropsVacant = WarePropsVacant + 1;
          print(WarePropsVacant);
        }
      ...
      for (var i in value.docs) {
        if ((i["Property_Details"]["Property_Types"]["Warehouse"]) == true) {
          if ((i["Property_Details"]["Asset"]) != "") {
            WareTotalAsset =
                WareTotalAsset + int.parse((i["Property_Details"]["Asset"]));
          }
      ...
      for (var i in value.docs) {
        if ((i["Property_Details"]["Property_Types"]["Warehouse"]) == true) {
          if ((i["Property_Details"]["Rent"]) != "") {
            WareTotalRent =
                WareTotalRent + int.parse((i["Property_Details"]["Rent"]));
          }
        }
      }
      // suggestionslist=Properties;
    ...
    await FirebaseFirestore.instance
      ...
      for (var i in value.docs) {
        ...
        if (((i["Property_Details"]["Property_Types"]["Warehouse"]) == true) &&
          ...
          WarePropsUpcom = WarePropsUpcom + 1;
          print(WarePropsVacant);
        }
      ...
      if (WareTotalAsset != 0) {
        yield = (((WareTotalRent) * 100) / (WareTotalAsset)).toInt();
      }
      // suggestionslist=Properties;
    });
  }
