...
class ChatwrtTenantPage extends StatefulWidget {
  ChatwrtTenantPage({Key? key}) : super(key: key);
   
  State<ChatwrtTenantPage> createState() => _ChatwrtTenantPageState();
}

class _ChatwrtTenantPageState extends State<ChatwrtTenantPage> {
...
void search(String query){
  ...
  final suggestions1=Properties.where((element){
    final item=element.Tenantname.toLowerCase();
